...
export default function Register() {
    ...
    return (
        <GuestLayout>
            ...
            <h1 className="m-3 font-black text-xl text-purple-500">Create your account</h1>
            <form onSubmit={submit}>
                <div>
                    <InputLabel htmlFor="name" className="dark:text-white" value="Name" />
                ...
                <div className="mt-4">
                    <InputLabel htmlFor="password_confirmation" className="dark:text-white" value="Confirm Password" />
